...
/**
 * Example for how to generate Master List Signer certificate
 * @author dream
 *
 */
public class MasterListSignerCert {
	...
	public static X509Certificate issueCert(String dn, PublicKey pubKey, X509Certificate signerCert, PrivateKey signingKey) {
		...
		cp.getExtKeyUsageType()
				.addExtKeyUsage(KeyPurposeId.getInstance(ICAOObjectIdentifiers.id_icao_cscaMasterListSigningKey));
