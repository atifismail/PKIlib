...
/**
 * Example for how to generate Document Signer certificate
 * @author dream
 *
 */
public class DSCertificate {
	...
	public static X509Certificate issueCert(String dn, PublicKey pubKey, X509Certificate signerCert, PrivateKey signingKey) {
		...
		dp.addCrlDisPoint("127.0.0.1", CRLDistributionPointsType.iPAddress, signerCert.getSubjectX500Principal().toString(),
